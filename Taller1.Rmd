...
**Tabla de área:** la unidad de observación es el *municipio*, ya que constituye el elemento básico sobre el cual se registran los datos. Cada fila corresponde a las variables asociadas a un municipio.

**Tabla de población:** la unidad de observación también es el *municipio*, dado que este es igualmente el nivel territorial en el que se recopila y organiza la información de la tabla.
...
Se optó por realizar un *left join con relación many-to-one*, dado que la tabla de población contiene múltiples observaciones por municipio a lo largo de distintos años, mientras que la tabla de área registra una única observación por municipio (información estática). Este tipo de unión asegura que se conserven todas las filas de la tabla de población y que a cada una de ellas se le añadan los atributos de área correspondientes al municipio. De esta manera, se garantiza que no se pierda información temporal de población y, al mismo tiempo, se complementa cada registro municipio–año con la información de área cuando está disponible.
