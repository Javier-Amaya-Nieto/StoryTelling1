...
# Esto ya lo habíamos verificado, pero incluimos el paso por seguridad
...
#### 4. ¿Cómo ha cambiado la distribución de la población municipal colombiana desde 1985? Puede realizar un análisis por cuartiles o percentiles con gráficos.

```{r}
# Calcular percentil ÿ cuartil de cada municipio por año
pob_percentiles <- base_final_mpio %>%
  group_by(ano) %>%
  mutate(
    percentil = ntile(poblacion, 100),
